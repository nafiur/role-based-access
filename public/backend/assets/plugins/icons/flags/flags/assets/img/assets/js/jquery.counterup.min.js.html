...
<head>
	...
	<!-- Google Tag Manager -->
	<script type="b0b5ccab27a9c77f1b710210-text/javascript">(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
...
<body>
						...
						<div class="row">
							<div class="col-lg-6">
								...
								<form method="post" id="contact_form">
									...
									<button class="btn btn-primary" onclick="if (!window.__cfRLUnblockHandlers) return false; emailcreate()" data-cf-modified-b0b5ccab27a9c77f1b710210-="">Submit Enquiry</button>
								</form>
							</div>
							<div class="col-lg-6">
								<div class="section-img">
							...
							<div class="row align-items-center">
								...
								<div class="col-lg-3">
									<div class="copyright-text">
										<p class="mb-0"> Copyright Year - 2013 - <script type="b0b5ccab27a9c77f1b710210-text/javascript">
	...
	<!-- jQuery -->
	<script src="assets/js/jquery-3.7.1.min.js" type="b0b5ccab27a9c77f1b710210-text/javascript"></script>
	
	<!-- Bootstrap Core JS -->
	<script src="assets/js/bootstrap.bundle.min.js" type="b0b5ccab27a9c77f1b710210-text/javascript"></script>
	<script src="assets/js/bootstrap-scrollspy.js" type="b0b5ccab27a9c77f1b710210-text/javascript"></script>

	<!-- Feather JS -->
	<script src="assets/js/feather.min.js" type="b0b5ccab27a9c77f1b710210-text/javascript"></script>
	
	<!-- Aos -->
	<script src="assets/plugins/aos/aos.js" type="b0b5ccab27a9c77f1b710210-text/javascript"></script>

	<!-- counterup JS -->
	<script src="assets/js/jquery.waypoints.js" type="b0b5ccab27a9c77f1b710210-text/javascript"></script>
	<script src="assets/js/jquery.counterup.min.js" type="b0b5ccab27a9c77f1b710210-text/javascript"></script>
		
	<!-- Owl Carousel JS -->
	<script src="assets/js/owl.carousel.min.js" type="b0b5ccab27a9c77f1b710210-text/javascript"></script>

	<!-- Custom JS -->
	<script src="assets/js/script.js" type="b0b5ccab27a9c77f1b710210-text/javascript"></script>

	<!-- Google tag (gtag.js) -->
	<script async src="https://www.googletagmanager.com/gtag/js?id=G-YY0YK6GN6S" type="b0b5ccab27a9c77f1b710210-text/javascript"></script>
	<script type="b0b5ccab27a9c77f1b710210-text/javascript">
	...
	<!-- Google Tag Manager -->
	<script type="b0b5ccab27a9c77f1b710210-text/javascript">(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
	j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
	'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
...
<script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="b0b5ccab27a9c77f1b710210-|49" defer></script></body>
</html>